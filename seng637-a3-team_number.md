...
![Line coverage results for DataUtilities](images/image9.png)

*Figure: Line coverage report showing the number of covered and missed lines for each method in the DataUtilities class.*
---
